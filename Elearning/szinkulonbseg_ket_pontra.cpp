...
int main() {
	...
	// a bal felsõ és a jobb alsó sarokban álló pont Lab színtérbeli teljes színkülönbsége
	...
	// a bal felsõ sarokban lévõ és a tõle jobbra lévõ szomszéd teljes színkülönbsége
